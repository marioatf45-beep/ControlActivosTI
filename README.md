...
1. Ejecutar en orden `supabase/01_auth_profiles.sql`, `supabase/02_servicedesk.sql`, `supabase/03_auth_hardening.sql`, `supabase/04_service_role_profile_fix.sql` y `supabase/05_gate_control.sql` desde Supabase SQL Editor. Realizar un respaldo previo.
