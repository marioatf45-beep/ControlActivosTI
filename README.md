...
1. Ejecutar en orden los scripts `supabase/01_auth_profiles.sql` a `supabase/06_central_inventory.sql` desde Supabase SQL Editor. Realizar un respaldo previo.
