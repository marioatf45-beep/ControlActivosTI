...
1. Ejecutar en orden `supabase/01_auth_profiles.sql`, `supabase/02_servicedesk.sql` y `supabase/03_auth_hardening.sql` desde Supabase SQL Editor. Los scripts son idempotentes; realizar un respaldo previo.
